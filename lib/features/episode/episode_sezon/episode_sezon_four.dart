...
class EpisodeSezonFour extends StatelessWidget {
  const EpisodeSezonFour({Key? key, required this.model}) : super(key: key);
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemBuilder: (context, index) =>  Episode(model: model.results[index],),
